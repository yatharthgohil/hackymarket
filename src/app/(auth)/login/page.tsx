    ...
    <div className="min-h-screen flex items-center justify-center px-4 auth-page-background">
      <div className="w-full max-w-sm">
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3 px-4 bg-background border border-border rounded-lg text-foreground font-medium flex items-center justify-center gap-3 hover:bg-card transition-colors disabled:opacity-50"
        >
